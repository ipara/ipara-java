...
<%@ page import="ipara.core.request.OneStepPaymentRequest" %>
...
<%
  ...
  if ("POST".equalsIgnoreCase(request.getMethod())) {
    ...
    dto.setSuccessUrl("https://apitest.ipara.com/rest/payment/threed/test/result");
    dto.setFailureUrl("https://apitest.ipara.com/rest/payment/threed/test/result");
    dto.setEcho("Echo");
    dto.setVersion("1.0");
