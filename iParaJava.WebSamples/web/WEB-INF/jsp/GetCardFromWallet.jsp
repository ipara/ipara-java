<%-- 
    Document   : GetCardFromWallet
    Created on : Sep 13, 2017, 11:02:48 AM
    Author     : fcoskun
--%>

<%@page import="com.google.gson.GsonBuilder"%>
<%@page import="iParaJava.Core.Response.BankCardInquryResponse"%>
<%@page import="iParaJava.Core.Request.BankCardInquiryRequest"%>
...
if ("POST".equalsIgnoreCase(request.getMethod())) {
            ...
            BankCardInquryResponse bankCardInquiryResponse = BankCardInquiryRequest.Execute(bankCardInquiryRequest, settings);
            
         
               out.println( "  <h1>Sonuç</h1>");
   Gson g = new GsonBuilder().disableHtmlEscaping().setPrettyPrinting().create();
         out.println("<pre>"+g.toJson(bankCardInquiryResponse)+"</pre>"); 
}
%>
