<%-- 
    Document   : AddCardToWallet
    Created on : Sep 13, 2017, 11:02:39 AM
    Author     : fcoskun
--%>

<%@page import="com.google.gson.GsonBuilder"%>
<%@page import="iParaJava.Core.Response.BankCardCreateResponse"%>
<%@page import="iParaJava.Core.Request.BankCardCreateRequest"%>
...
if ("POST".equalsIgnoreCase(request.getMethod())) {
            ...
            BankCardCreateResponse  bankCardCreateresponse = BankCardCreateRequest.Execute(bankCardCreateRequest, settings);
